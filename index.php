    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="col-md-6 col-md-offset-3">
          ...
          <p>Couple of reasons. I have to take a course in web development for my degree, it would be silly to spend time on an intro into HTML/CSS since my skill level exceeds that and it's convenient that this one takes place during the summer. Not to sound arrogant, but I don't think I would have learned much in any of the web dev courses and this one seemed to be the most interesting/challenging one.</p>
          ...
          <p>Mostly Mac, though I just bought a new PC and will most likely dualboot between Windows and Linux.</p>
          <h2>Anything else we should know?</h2>
          <p>I used to be a dog person, but cats have slowly started taking over with their fluffyness.</p>
        </div>
      </div>
    </div>
